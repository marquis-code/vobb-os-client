...
const DirectoryCard = ({ name, fileCount, folderSize }: DirectoryCardProps) => {
  return (
    <div className="flex w-[272px] items-center justify-start gap-2 rounded-[12px] border border-vobb-neutral-30 mx-0 m-4">
