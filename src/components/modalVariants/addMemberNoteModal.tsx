...
import { Button, CustomInput, CustomTextarea, Modal, UsersDropdown } from "components";
import React, { useEffect, useState } from "react";
import { ExistingUserTypes, MemberProfileProps, ModalProps, optionType } from "types";
...
interface AddMemberNoteModalProps extends ModalProps {
  submit: (data: AddNoteData) => void;
  loading: boolean;
...
const AddMemberNoteModal: React.FC<AddMemberNoteModalProps> = ({
  show,
  close,
  submit,
  loading,
  ...
  const onSubmit: SubmitHandler<AddNoteData> = (data) => {
    submit(data);
    reset();
  };
  ...
  useEffect(() => {
    if (debouncedTitle && debouncedBody && dirtyFields.title && dirtyFields.body) {
