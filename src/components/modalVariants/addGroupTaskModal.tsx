...
export const AddGroupTaskModal: React.FC<AddMemberTaskModalProps> = ({
  show,
  close,
  submit,
  loading,
    ...
    <Modal contentClassName="max-w-[944px] p-0" show={show} close={close} testId="addTask-modal">
      ...
      <form className="px-4 border-b border-vobb-neutral-20 divide-y-[1px]">
        ...
        <CustomInput
          ...
          className="!border-none focus:!outline-none  shadow-none focus-visible:ring-transparent h-11"
