...
import { ObjectOptionProps, priorityOptions, statusOptions } from "lib";
...
const EditGroupTaskModal: React.FC<EditMemberTaskModalProps> = ({
  show,
  close,
  submit,
  loadingTask,
        ...
        <>
          <form className="mx-4 border-b border-vobb-neutral-20 divide-y-[1px]">
            <CustomInput
              ...
              className="!border-none shadow-none focus:!outline-none focus-visible:ring-transparent h-11 font-medium"
