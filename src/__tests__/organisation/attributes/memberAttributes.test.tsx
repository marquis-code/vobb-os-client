...
describe("MemberAttributes", () => {
  ...
  it("renders the component with correct data", () => {
    render(<MemberAttributes {...mockProps} />);

    expect(screen.getByText("New member attribute")).toBeInTheDocument();
  ...
  it("calls handleAddAttribute when the add button is clicked", () => {
    render(<MemberAttributes {...mockProps} />);
    fireEvent.click(screen.getByText("New member attribute"));
  ...
  it("calls handleEditAttribute when edit button is clicked", () => {
    ...
    expect(mockProps.handleEditAttribute).toHaveBeenCalledWith(
      mockProps.memberAttributes.attributesArray[0]
    );
  });
