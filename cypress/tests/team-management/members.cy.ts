...
describe("Organisation Members", () => {
  ...
  it("displays invite member modal when button is clicked", () => {
    ...
    cy.get("[data-cy='invite-modal']").within(() => {
  ...
  it("Resends invitation", () => {
    cy.get("[data-cy='menu-inactiveUser']").eq(0).click();
    cy.get("div").contains("Actions").should("exist");
    cy.get("[data-cy='cancel-invite']")
      .contains("Cancel invitation")
      .within(() => {
        cy.get("svg").should("exist");
      });
    cy.get("[data-cy='resend-invite']").contains("Resend invitation").click();
  ...
  it("Cancels invitation", () => {
    cy.get("[data-cy='menu-inactiveUser']").eq(1).click();
    cy.get("div").contains("Actions").should("exist");
    ...
    cy.get("[data-cy='cancel-invite']").contains("Cancel invitation").click();
  ...
  it("displays actions options for active user", () => {
    cy.get("[data-cy='menu-activeUser']").eq(0).click();

    cy.get("div").contains("Actions").should("exist");
    cy.get("[data-cy='view-member']")
      .contains("View member")
      .within(() => {
        cy.get("svg").should("exist");
      });
    cy.get("[data-cy='change-role']")
      .contains("Change role")
      .within(() => {
        cy.get("svg").should("exist");
      });
    cy.get("[data-cy='suspend-member']")
  ...
  it("displays change role modal for active user", () => {
    cy.get("[data-cy='menu-activeUser']").click();
    cy.get("[data-cy='change-role']").contains("Change role").click();

    cy.get("[data-cy='changeRole-modal']").within(() => {
      cy.get("[data-cy='close-btn']").should("be.visible").and("be.enabled");
  ...
  it("displays suspend member modal for active user", () => {
    cy.get("[data-cy='menu-activeUser']").click();
    cy.get("[data-cy='suspend-member']").contains("Suspend member").click();

    cy.get("[data-cy='suspendMember-modal']").within(() => {
      cy.get("[data-cy='close-btn']").should("be.visible").and("be.enabled");
  ...
  it("view member button for active user leads to member's page", () => {
    cy.get("[data-cy='menu-activeUser']").eq(0).click();
    cy.get("[data-cy='view-member']").click();
